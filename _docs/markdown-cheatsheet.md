...
```
![Minion](http://octodex.github.com/images/minion.png){:class="img-responsive"}

or
``` markdown
![Alt text](http://octodex.github.com/images/stormtroopocat.jpg "The Stormtroopocat"){:class="img-responsive"}
```
![Alt text](http://octodex.github.com/images/stormtroopocat.jpg "The Stormtroopocat"){:class="img-responsive"}
...
![Alt text][id]
```
![Alt text][id]{:class="img-responsive"}
...
Source: [https://gist.github.com/jonschlinkert/5854601](https://gist.github.com/jonschlinkert/5854601)
